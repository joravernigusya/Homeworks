...
# var_str - "No".
# 2. Измените значение, хранимое в переменной var_int, увеличив его в
# 3.5 раза, результат свяжите с переменной big_int.
# 3. Измените значение, хранимое в переменной var_float, уменьшив
# его на единицу, результат свяжите с той же переменной.
...
def activity_with_var(var_int, var_float, var_str):
    big_int = int(3.5 * var_int)
    var_float -= 1
    var_int / var_float
    big_int / var_float
    var_str = var_str * 2 + "Yes" * 3
    print(var_int, var_float, var_str, big_int, sep="\n")
