...
"""
rand_str1 = "wildermade"
lst_rand_str1 = list(rand_str1)
lst_rand_str1.pop(0)
lst_rand_str1.pop(8)
lst_rand_str1.pop(2)
lst_rand_str1.pop(-3)
new_rand_str1 = "".join(lst_rand_str1)
print(new_rand_str1, len(new_rand_str1), sep="\n")

# 2. Присвойте произвольную строку длиной 10-15 символов переменной
# и извлеките изнее следующие срезы.

rand_str2 = "disintegration"
slc1_rand_str2 = rand_str2[:8]  # первые восемь символов
print(slc1_rand_str2)
slc2_rand_str2 = rand_str2[5:-5]  # четыре символа из центра строки
print(slc2_rand_str2)

# Вывод символов, кратным трем.

for i in range(len(rand_str2)):
    if i % 3 == 0:
        print(rand_str2[i])
slc4_rand_str2 = rand_str2[::-1]  # перевернутая строка
